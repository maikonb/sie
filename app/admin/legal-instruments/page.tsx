    ...
    <PageShell>
      <PageHeader>
        <div className="space-y-1">
          <PageHeaderHeading>Instrumentos Jurídicos</PageHeaderHeading>
          <PageHeaderDescription>Gerencie os modelos de documentos e contratos utilizados no sistema.</PageHeaderDescription>
        </div>
