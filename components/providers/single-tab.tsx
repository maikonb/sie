...
const SingleTabContext = createContext<SingleTabContextType | undefined>(undefined)
...
export function SingleTabProvider({ children }: { children: React.ReactNode }) {
  ...
  return <SingleTabContext.Provider value={{ isBlocked, isChecking, takeOver }}>{children}</SingleTabContext.Provider>
}
